        ...
        <section className="forum-section">
          <Container fluid="lg">
            ...
            <div className="forum-page-header">
              <div>
                <h1 className="forum-page-title">Fórum</h1>
            ...
            {loading ? (
              ...
              <div className="forum-categorias-card mb-4">
                {/* Cabeçalho */}
                <div className="forum-categorias-header">
                  <div style={{ flex: "0 0 260px" }}>Categoria</div>
                  <div style={{ width: 90, textAlign: "center" }}>Tópicos</div>
              ...
              {[
                {
                  to: "/forum/bookmarks",
                  icon: "🔖",
                  titulo: "Meus Bookmarks",
                  desc: "Tópicos e posts salvos",
                  privado: true,
                },
                {
                  to: "/forum?sort=curtidas",
                ...
                },
                {
                  ...
                  icon: "🕐",
                  titulo: "Recentes",
                  desc: "Última atividade",
                  privado: false,
                },
              ]
                .filter((item) => !item.privado || usuario)
                .map((item) => (
                  <Col sm={6} md={4} key={item.to}>
                    <Link to={item.to} className="forum-quick-link">
                      <span className="forum-quick-link-icon">{item.icon}</span>
                      <div>
                        <div className="forum-quick-link-titulo">
                          {item.titulo}
                        </div>
                        <div className="forum-quick-link-desc">{item.desc}</div>
                      </div>
                    </Link>
                  </Col>
                ))}
