...
const schema = yup.object().shape({
  ...
  senha: yup.string().min(8, 'A senha deve conter no mínimo 8 caracteres!')
        ...
        .matches(/[!@#$%^&*]/, 'A senha deve conter pelo menos um caracter especial')
            ...
            <Form
                ...
                <Form.Group
                    ...
                    <Form.Control
                        ...
                        required
                        isInvalid={!!erro.nome}
                        aria-invalid={formData.usuario ? "border border-success" : "border border-danger"}
                        className='fs-5'
                        style={{width: "300px"}}
                    />
                    <Form.Control.Feedback
                        type="invalid">{erro.nome}
                    </Form.Control.Feedback>
                </Form.Group>
                ...
                <Form.Group
                    ...
                    <Form.Control
                        ...
                        aria-invalid={formData.email ? "border border-success" : "border border-danger"}/>
                    <Form.Control.Feedback
                        type="invalid">{erro.email}
                    </Form.Control.Feedback>
            </Form.Group>
                ...
                <Form.Group
                    ...
                    <Form.Control.Feedback
                        type="invalid">{erro.confirmarSenha}
                    </Form.Control.Feedback>
            </Form.Group>
                    <Button
                    variant="dark"
                    ...
                    className="fs-4"
                    style={{width: "150px"}}
                        disabled={!formData.usuario || !formData.email || !formData.senha || !formData.confirmarSenha ? true : false}>
                            Cadastrar
                </Button>
                <Container className="d-flex flex-column mt-4 mb-4 justify-content-center g-4">
                    <span className='fs-5'>Já é cadastrado?</span>
                    <a href='/login' className='fs-5'>Faça seu Login</a>
                </Container>
            </Form> 
        </Container>
